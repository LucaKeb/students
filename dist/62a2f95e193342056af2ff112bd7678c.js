...
},{"../database":47}],39:[function(require,module,exports) {
"use strict";
...
},{"../database":47}],36:[function(require,module,exports) {
"use strict";
...
function saveStudent(event) {
    ...
    try {
        var course_1 = courseService.getById(Number(selectCourse.value));
        //  course = new Course(selectCourse.options[selectCourse.selectedIndex].text);
        student = new Student_1.Student(iptName.value, course_1);
...
function listStudent() {
    ...
    for (var _i = 0, _a = studentService.listStudent(); _i < _a.length; _i++) {
        student = _a[_i];
        tblStudent.innerHTML = tblStudent.innerHTML + (" <tr>\n    <td id=\"\">" + student.getName() + "</td>\n    <td>" + student.getEmail() + "</td>\n    <td>" + student.yearBirth + "</td>\n    <td>" + student.getAge() + "</td>\n    <td>" + student.course.name + " </td>\n  </tr> ");
    }
}
function listCourse() {
    for (var _i = 0, _a = courseService.list(); _i < _a.length; _i++) {
        var course_2 = _a[_i];
        selectCourse.innerHTML = selectCourse.innerHTML + ("<option value=" + course_2.id + "> " + course_2.name + " </option> ");
    }
}
listCourse();
...
},{"./Student":42,"./StudentService":43,"../course/CourseService":39}],52:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/62a2f95e193342056af2ff112bd7678c.map