...
},{"../Person":46}],41:[function(require,module,exports) {
"use strict";
...
},{"../database":47}],27:[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var Course_1 = require("./Course");
var CourseService_1 = require("./CourseService");
var frmCourse = document.getElementById("frmCourse");
var tblCourse = document.getElementById("tblCourse");
var courseService = new CourseService_1.CourseService();
var course;
function save(event) {
    event.preventDefault();
    var course = new Course_1.Course(frmCourse.iptName.value);
...
function list() {
    ...
    for (var _i = 0, _a = courseService.list(); _i < _a.length; _i++) {
        course = _a[_i];
        tblCourse.innerHTML = tblCourse.innerHTML + ("  <tr> <td> " + course.name + " </td> </tr>");
    }
}
frmCourse.addEventListener("submit", save);
},{"./Course":38,"./CourseService":39}],52:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/6593b7a6103290852103efe87486c511.map